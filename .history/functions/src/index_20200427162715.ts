...
exports.solicitaRepartidor = functions.database.ref('pedidos/repartidor_pendiente/idPedido')
    .onCreate(async (snapshot, context) => {
        ...
        .then((snapRepartidores: RepartidorAsociado[]) => Object.values(snapRepartidores))
        .then(repartidores => {
            ...
            repartidores.sort((a, b) => a.pedidos_activos - b.pedidos_activos)
            repartidores.sort((a, b) => a.last_pedido - b.last_pedido)
        })
        .catch(err => console.log(err))
    });
